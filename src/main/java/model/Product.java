...
public class Product {
    ...
    public Product(int id, String name, byte[] imageData, String description, double price, int catalogId) {
        this.id = id;
        this.name = name;
        this.imageData = imageData;
        this.description = description;
    ...
    public Product(int id, String name, String description, byte[] imageData, double price, String brandName, int catalogId) {
        this.id = id;
        this.name = name;
        this.description = description;
        this.imageData = imageData;
    ...
    public Product(int id, String name, byte[] imageData, String description, double price, String brandName, int catalogId) {
        this.id = id;
        this.name = name;
        this.imageData = imageData;
        this.description = description;
