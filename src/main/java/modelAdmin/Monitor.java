...
public class Monitor {
    ...
    public Monitor(int monitorId, int productId, String model, float size, String panelType, String resolution, String bitDepth, String colorGamut, int brightness, int refreshRate, String hdr, String ports, boolean audioOut, String functionKeys, float weight, String dimensions, String color, String productName, String description, byte[] image) {
