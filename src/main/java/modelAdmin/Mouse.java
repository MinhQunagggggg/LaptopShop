...
public class Mouse {
    ...
    // Constructor
    public Mouse(int mouseId, int productId, String brand, int warrantyMonths, String connectionType, boolean wired, int dpi, String switchType, String mouseLed, String color, String dimensions, float weight, String productName, String description, int accessoryBrandId, byte[] imageData) {
