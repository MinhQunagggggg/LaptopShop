...
public class ProductSpecificationDAO {
    ...
    public boolean updateSpecification(ProductSpecification spec) {
        String query = "UPDATE ProductSpecifications SET cpu=?, ram=?, storage=?, resolution=?, graphics=?, " +
         ...
         try ( Connection conn = new DBContext().getConnection(); 
            ...
            stmt.setString(2, spec.getRam());
            stmt.setString(3, spec.getStorage());
            stmt.setString(4, spec.getResolution());
            stmt.setString(5, spec.getGraphics());
            stmt.setString(6, spec.getPorts());
            stmt.setString(7, spec.getWireless());
            stmt.setString(8, spec.getCamera());
            stmt.setString(9, spec.getBattery());
            stmt.setString(10, spec.getDimensions());
            stmt.setString(11, spec.getWeight());
            stmt.setString(12, spec.getKeyboard());
            stmt.setString(13, spec.getMaterial());
            stmt.setString(14, spec.getWarranty());
            stmt.setString(15, spec.getOs());
            stmt.setString(16, spec.getCondition());
            stmt.setString(17, spec.getRefreshRate());
            stmt.setInt(18, spec.getProductId());
