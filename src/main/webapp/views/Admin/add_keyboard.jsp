    ...
    <body class="sb-nav-fixed">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="form-container">
                        <h2>Thêm Bàn Phím Mới</h2>
                        <form action="AddKeyboard" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
                            <div class="form-grid">
                                ...
                                <div>
                                    ...
                                    <select name="accessoryBrandId" required>
                                ...
                                <div>
                                    ...
                                    <select name="warrantyMonths" required>
                                ...
                                <div>
                                    <label>Chất liệu keycap:</label>
                                    <select name="keycapMaterial">
                                ...
                                <div>
                                    ...
                                    <select name="dimensions">
                                        ...
                                        <option value="450 x 140 x 40 mm">450 x 140 x 40 mm</option>
                                        <option value="420 x 125 x 30 mm">420 x 125 x 30 mm</option>
                                    </select>
                                ...
                                <div>
                                    ...
                                    <select name="batteryCapacity">
                                        <option value="" disabled selected>Chọn dung lượng (tùy chọn)</option>
                                        <option value="None">None</option>
                                        <option value="2000">2000 mAh</option>
                                        <option value="3000">3000 mAh</option>
                                        <option value="4000">4000 mAh</option>
                                    </select>
                                    <span class="error" id="batteryError"></span>
                                </div>

                                <div>
                                    <label>Profile keycap:</label>
                                    <select name="keycapProfile">
                                        <option value="" disabled selected>Chọn profile (tùy chọn)</option>
                            ...
                            <input type="submit" value="Thêm Bàn Phím" class="submit-btn">
                        </form>
                    </div>
                </main>
        ...
        <script>
                            function validateForm() {
                                ...
                                let numberFields = ["warrantyMonths", "weight", "batteryCapacity", "price", "stock"];
                                let errorMessages = {
                                    "warrantyMonths": "Thời gian bảo hành phải là số dương",
                                    "weight": "Trọng lượng phải là số nguyên dương",
                                    "batteryCapacity": "Dung lượng pin phải là số nguyên dương",
                                ...
                                if (dimensionsValue && !/^\d{2,4} x \d{2,4} x \d{2,4} mm$/.test(dimensionsValue)) {
                                    dimensionsError.textContent = "Kích thước phải có định dạng '435 x 130 x 35 mm'";
                                    valid = false;
                                } else {
