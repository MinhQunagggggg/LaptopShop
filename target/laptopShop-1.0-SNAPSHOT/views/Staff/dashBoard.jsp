...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <a class="navbar-brand ps-3" href="Dashboard"><p>Hello, ${user.name}</p></a>
                            ...
                            <div class="col-xl-2 col-md-6">
                                <div class="card bg-secondary text-white mb-4">
                                    <div class="card-body">
                                        ...
                                        Today's Revenue
                                        <h4 id="today-revenue"></h4>
                                    </div>

                                    <script>
                                        // Gi? s? todayRevenue ???c truy?n t? backend ho?c template engine
                                        const todayRevenue = ${todayRevenue};
                                        document.getElementById('today-revenue').innerText = todayRevenue.toLocaleString('vi-VN', {style: 'currency', currency: 'VND'});
                                    </script>
