...
<body>
    ...
    <div class="container profile-container">
        ...
        <div class="sidebar text-center">
            ...
            <ul class="list-group">
                ...
                <li class="list-group-item active"><a href="ChangePassword">Change Password</a></li>
        ...
        <div class="profile-card">
            ...
            <% } else if ("true".equals(error)) { %>
                <div class="alert alert-danger alert-dismissible fade show" role="alert">
                    <strong>Error!</strong> Failed to update password. Please try again.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
    ...
    <script>
        function validateForm() {
            ...
            // Kiểm tra Current Password không rỗng
            if (currentPassword.trim() === "") {
                alert("Current Password cannot be empty.");
                return false;
            }

            // Kiểm tra New Password: ít nhất 8 ký tự, có chữ hoa, chữ thường, số và ký tự đặc biệt
