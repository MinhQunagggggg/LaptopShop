        ...
        <div class="container">
            ...
            <form action="ViewOrder" method="GET">
                <ul class="order-status-nav">
                    <li>
                        <a class="${empty param.status_id ? 'active' : ''}" href="ViewOrder">All</a>
                    </li>
                    <li>
                        <a class="${param.status_id == '1' ? 'active' : ''}" href="ViewOrder?status_id=1">Pending Confirmation</a>
                    </li>
                    <li>
                        <a class="${param.status_id == '2' ? 'active' : ''}" href="ViewOrder?status_id=2">Processing</a>
                    </li>
                    <li>
                        <a class="${param.status_id == '3' ? 'active' : ''}" href="ViewOrder?status_id=3">Delivered</a>
                    </li>
                    <li>
                        <a class="${param.status_id == '4' ? 'active' : ''}" href="ViewOrder?status_id=4">Canceled</a>
                    </li>
                </ul>
            </form>
            ...
            <c:if test="${not empty orders}">
                ...
                <c:forEach var="order" items="${orders}" varStatus="loop">
                    <c:if test="${empty sessionScope.status_id or order.status_id == sessionScope.status_id}">
                        ...
                        <c:if test="${order.order_id != currentOrderId or loop.first}">
                            <c:if test="${currentOrderId != -1 and not loop.first}">
                                ...
                                <div class="order-footer">
                                    ...
                                    <div class="action-buttons">
                                        <c:if test="${status_id == 3 or status_id == 4}">
                                            <a href="${pageContext.request.contextPath}/BuyAgain?order_id=${currentOrderId}" class="action-btn">Buy Again</a>
                                        </c:if>
                                        <c:if test="${status_id == 1}">
                                            <button type="button" class="action-btn" data-bs-toggle="modal" data-bs-target="#confirmCancelModal_${currentOrderId}">
                                                Cancel Order
                                            </button>
                                            <div class="modal fade" id="confirmCancelModal_${currentOrderId}" tabindex="-1" aria-labelledby="modalLabel" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title text-danger" id="modalLabel">Confirm Cancellation</h5>
                            ...
                            </div> <!-- Close previous order-section -->
                        </c:if>
                        <div class="order-section">
                            ...
                            <c:set var="status_id" value="${order.status_id}" />
