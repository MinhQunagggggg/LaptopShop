    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <p class="small">
                    Laptop Shop offers genuine laptops, best prices, and reliable warranty. 
                    Committed to providing an excellent shopping experience for our customers!
                </p>
            </div>

            <!-- 🔹 Column 2: Google Map - Store Location -->
            <div class="col-md-4">
                <h5 class="fw-bold text-uppercase">Store Location</h5>
                ...
                <p class="mt-2 small"><i class="fas fa-map-marker-alt"></i> 123 Nguyen Van Cu Street, Ho Chi Minh City</p>
            </div>
            ...
            <div class="col-md-4">
                ...
                <p class="small">
                    <i class="fas fa-phone-alt"></i> <strong>Hotline:</strong> 0345932620 <br>
                    <i class="fas fa-envelope"></i> <strong>Email:</strong> quangdmce182250@fpt.edu.vn <br>
        ...
        <p class="mb-0 small">Designed by Minh Quang <strong>TPFShop</strong></p>
    </div>
</footer>
<style>
    /* 🔹 Container spacing */
