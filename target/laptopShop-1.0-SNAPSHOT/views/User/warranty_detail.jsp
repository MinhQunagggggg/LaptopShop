                    ...
                    <c:otherwise>
                        <div class="warranty-content">
                            ...
                            <div class="warranty-info">
                                ...
                                <div class="product-name">
                                    ${warrantyDetail.productName} (${warrantyDetail.ram})
                                </div>
                                <div class="warranty-status">
                                    Warranty Status: 
                                    <c:choose>
                                        <c:when test="${warrantyDetail.warrantyEndDate > currentDate}">
                                ...
                                <c:if test="${warrantyDetail.warrantyEndDate > currentDate}">
                        ...
                        <c:if test="${warrantyDetail.warrantyEndDate > currentDate}">
                            <c:if test="${not empty successMessage}">
                                <div class="alert alert-success alert-dismissible fade show" id="successAlert">${successMessage}
                                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                </div>
                            </c:if>
                            <c:if test="${not empty errorMessage}">
                                <div class="alert alert-danger alert-dismissible fade show" id="errorAlert">${errorMessage}
                                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                </div>
                            </c:if>
                            <div class="repair-form">
                                ...
                                <form action="${pageContext.request.contextPath}/SubmitRepairRequest" method="post">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="repairReason" name="repairReason" rows="3" required placeholder="Please describe the issue with your product..."></textarea>
                                    </div>
                        ...
                        <!-- Nút xem trạng thái sửa chữa hiện có -->
                        <c:if test="${warrantyDetail.warrantyEndDate > currentDate and warrantyDetail.isRepairing}">
                            <div class="text-center mt-4">
                                <a href="${pageContext.request.contextPath}/RepairStatus?orderDetailId=${warrantyDetail.orderdetailId}" 
                                   class="btn-repair-status">View Repair Status</a>
                            </div>
                        </c:if>
